...
public class RestResponse{
    ...
    /**
     * @return status line as string from response object
     */
    public String getStatusLine() {
        return response.then().extract().statusLine();
    }
    ...
    public String getAllheadersAsString() {
        return response.then().extract().headers().toString();
    }
    ...
    public int getHeaderSize() {
        return response.then().extract().headers().size();
    }
    ...
    public int getCookiesSize() {
        return response.then().extract().cookies().size();
    }
    ...
    public RestResponse hamcrestResponseBodyValidation(String validationType, String elementName, String expectedResults) {
        switch (validationType) {
            case "equalTo":response.then().body(elementName, equalTo(expectedResults)).log().ifValidationFails();break;
            case "equalToIgnoringCase":response.then().body(elementName, equalToIgnoringCase(expectedResults)).log().ifValidationFails();break;
            case "hasSize":response.then().body(elementName, hasSize(Integer.parseInt(expectedResults))).log().ifValidationFails();break;
            case "hasItem":response.then().body(elementName, hasItem(Integer.parseInt(expectedResults))).log().ifValidationFails();break;
            case "hasItemString":response.then().body(elementName, hasItem(expectedResults)).log().ifValidationFails();break;
            case "hasXpath":response.then().body(elementName, hasXPath(expectedResults)).log().ifValidationFails();break;
            case "containsString":response.then().body(elementName, containsString(expectedResults)).log().ifValidationFails();break;
            case "isEmptyString":response.then().body(isEmptyString()).log().ifValidationFails();break;
            default:break;
        }
        return this;
  ...
  * */
    ...
    */
    ...
    /*
    This will return value for specific Response Header
        */
    public String getIndividualResponseHeader(String headerName) {
        return response.getHeader(headerName);
    }

    public List<HashMap<String, String>> getList() {
        // TODO Auto-generated method stub
        //List<String> sampleresponse=response.jsonPath().getList("$");
